...
return '👨🏾‍🔧│ اصدار سورس العالمي س : *v'..version..'* \n📡'
end
...
elseif Text== "العالمي" then return sendMsg(msg.chat_id_,msg.id_,"[↯مالـك السورس↯](t.me/Alamy3")
elseif Text== "سام" then return sendMsg(msg.chat_id_,msg.id_,"[ ↯مطور سورس ↯](t.me/@XxxMalificentxxX")
