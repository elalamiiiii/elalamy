...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/alamyFILE/master/GetVersion.txt' ) or 0
...
send_key(msg.sender_user_id_,'   [قناة سورس : العالمي](https://t.me/tamer_hosni)' ,nil,inline,msg.id_)
return false
end
...
➠ [𝐃𝐄𝐕](t.me/XxxMalificentxxX)

➠ [𝐒𝐎𝐔𝐑𝐂𝐄](t.me/FlassTas10)

➠ [𝐓𝐎 𝐓𝐀𝐋𝐊 𝐓𝐎 𝐔𝐒](t.me/FlassTas4_bot)
]]
end
...
ــــــــــــــــــــــــــــــــ☆𝔸𝕃𝔸𝕄𝕐☆ـــــــــــــــــــــــــ
...
elseif Text== "العالمي الصغنن" or Text== "العالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطوري ^-^](https://t.me/Alamy3)")
elseif Text== "ملك التلجرام" or Text== "مطور السورس" then return  sendMsg(msg.chat_id_,msg.id_,"[العالميي](https://t.me/Alamy3)")
