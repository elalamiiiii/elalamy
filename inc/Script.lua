...
return'↯ شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(sela..':addnumberusers')..'】* عضـو .\n' 
end 
end
...
return 'ٴ𐄬 اصدار سورس العالمي ا : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'↯ عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس العالمي يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : العالمي ا](https://t.me/FlassTas10)' ,nil,inline,msg.id_)
return false
end
...
redis:del(Alamy..'replay:'..msg.chat_id_,sela..'replay_photo:group:'..msg.chat_id_,sela..'replay_voice:group:'..msg.chat_id_,
...
if names or photo or voice or imation or audio or sticker or video then
redis:del(Alamy..'replay:all',sela..'replay_photo:group:',sela..'replay_voice:group:',sela..'replay_animation:group:',sela..'replay_audio:group:',sela..'replay_sticker:group:',Alamy..'replay_video:group:')
...
★↯ -[𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒍𝒂𝒎𝒚 𖤍](t.me/FlassTas10) 

★↯ -[𝐓𝐎 𝐓𝐀𝑳𝐊 𝐔𝐒 𖤍](t.me/FlassTas4_bot)
]]
end
...
local NUM_MSG_Alamy = (redis:get(Alamy..'num_msg_sela'..msg.chat_id_) or 5)
...
elseif Text== "العالمي" or Text== "العالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[حبيب الكل](https://t.me/Alamy3)")
elseif Text== "ملك السورس" or Text== "مطور السورس" then return  sendMsg(msg.chat_id_,msg.id_,"[سام](https://t.me/XxxMalificentxxX)")
...
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 مرحباً عزيزي\nٴ𐄬 هذي اوامر التسليه:  \nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 رفع › تنزيل ❬ متوحد ❭\nٴ𐄬 رفع › تنزيل ❬ وتكه ❭\nٴ𐄬 رفع › تنزيل ❬ غبي ❭\nٴ𐄬 رفع › تنزيل ❬ كلب ❭\nٴ𐄬 رفع › تنزيل ❬ حمار ❭\nٴ𐄬 رفع › تنزيل ❬ زوجتي ❭\nٴ𐄬 رفع › تنزيل ❬ متوحده ❭\nٴ𐄬 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\nٴ𐄬 ❬ طلاق ❭ › ❬ زواج ❭\nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬")
 ...
 elseif Text== "ايديي" or Text=="ايدي ↯" then 
  ...
  elseif Text=="ابي رابط الحذف" or Text=="ابي رابط حذف" or Text=="رابط حذف" or Text=="رابط الحذف" or Text=="رابط ممس" then
  return sendMsg(msg.chat_id_,msg.id_,[[
...
↯رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "العالمي" or Text== "سام" or Text=="Alamy" then
...
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/DT_TC")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/XxxMalificentxxX")
end 
end 
